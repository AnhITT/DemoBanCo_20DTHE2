    ...
    public class ChessController : ControllerBase
    {
        ...
        public IActionResult insertRoom(string roomName)
        {
            ...
            if (userId != null)
            {
                ...
                usInRoom.RoomId = room.Id;
                usInRoom.UserId = userId;

                chessService.insertUserInRoom(usInRoom);
                List<UserInRoom> userInRoomTemp = new List<UserInRoom>();
                userInRoomTemp.Add(usInRoom);
                cachesManage.UserInRoom.Add(usInRoom.Id.ToString().ToLower(), userInRoomTemp);
            }
        ...
        [HttpPost]
        [Route("addUserToRoom")]
        public IActionResult addUserToRoom(Guid roomId, string userId) //user will get from entity sercurity
        {
            UserInRoom usInRoom = new UserInRoom();
            usInRoom.Id = Guid.NewGuid();
